...
import { createGameController, addPlayerController, addQuizController, addQuestionsController, deleteQuizController, initializeGameController, joinGame, getHostGamesController, getQuizForEditingController, updateQuestionController, updateAnswerController, deleteNicknameController, startGameController, getGameByIdController, getQuizByGameIdController, getNicknamesController, getFinalLeaderboardController, rescheduleGameController } from '../controllers/gameController';
...
router.delete('/quizzes/:quizId', authMiddleware, deleteQuizController);
